...
将 `kabatzinn-perspective` 目录放入你的 Agent 的 skills 目录即可。

**自动检测安装（推荐）**：
```bash
npx skills add kabatzinn-perspective
```
...
| Runtime | 路径 |
|---------|------|
| Claude Code | `~/.claude/skills/kabatzinn-perspective/` |
| Codex CLI | `~/.codex/skills/kabatzinn-perspective/` |
| Cursor | `~/.cursor/skills/kabatzinn-perspective/` |
